...
export default function Admin() {
  return (
    <div className="p-4 md:p-6 pb-20 md:pb-6 max-w-6xl mx-auto w-full">
      <h1 className="text-2xl font-bold mb-4">Yönetim</h1>
      <Tabs defaultValue="products">
        <TabsList className="rounded-xl flex-wrap h-auto">
          ...
          <TabsTrigger value="tables" className="rounded-lg">Masalar</TabsTrigger>
        ...
        <TabsContent value="tables" className="mt-4"><TableManager /></TabsContent>
