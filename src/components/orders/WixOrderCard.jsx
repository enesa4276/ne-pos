...
import { MapPin, Phone, Mail, ExternalLink, CheckCircle, ChefHat, Truck, PackageCheck, X, Printer } from 'lucide-react';
...
export default function WixOrderCard({ order, onStatusChange, onPrint, loading }) {
  ...
  return (
    <div className="bg-card rounded-2xl border border-border overflow-hidden">
      ...
      <div className="p-4 space-y-3">
        ...
        {/* Ürünler */}
        <div className="space-y-1 bg-secondary/30 rounded-xl p-2">
          {order.items?.length > 0 ? order.items.map((item, i) => (
            ...
            <p className="text-xs text-muted-foreground italic">Ürün bilgisi yok</p>
          )}
        </div>
